...
namespace Acme.OrderProject.Migrations
{
    ...
    [Migration("20250811112527_Added_Order_Repository")]
    partial class Added_Order_Repository
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.OrderProject.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.OrderProject.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.OrderProject.Orders.OrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.OrderProject.Stocks.Stock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.OrderProject.Orders.OrderLine", b =>
                {
                    b.HasOne("Acme.OrderProject.Orders.Order", null)
                        .WithMany("Lines")
